...
# ==================== ZONAS DISPONIBLES ====================
ZONAS = [
    "ACAPULCO", "AGUASCALIENTES", "APATZINGAN", "CABORCA", "CAMARGO", 
    "CAMPECHE", "CANCUN", "CARMEN", "CASAS-GRANDES", "CELAYA",
    "CENTRO-ORIENTE", "CENTRO-SUR", "CHETUMAL", "CHIHUAHUA", "CHILPANCINGO", 
    "CHONTALPA", "CIENEGA", "COATZACOALCOS", "COLIMA", "CORDOBA",
    "CUAUHTEMOC", "CUAUTLA", "CUERNAVACA", "CULIACAN", "DURANGO", 
    "FRESNILLO", "GUADALAJARA", "GUASAVE", "GUAYMAS", "HERMOSILLO",
    "HUAJUAPAN", "HUASTECA", "HUATULCO", "HUEJUTLA", "IGUALA", 
    "IRAPUATO", "IXMIQUILPAN", "IZUCAR", "JIQUILPAN", "JUAREZ",
    "LAGUNA", "LAZARO-CARDENAS", "LEON", "LOS-ALTOS", "LOS-MOCHIS", 
    "LOS-RIOS", "LOS-TUXTLAS", "MANZANILLO", "MATAMOROS", "MATEHUALA",
    "MAZATLAN", "MERIDA", "MINAS", "MONCLOVA", "MONTEMORELOS", 
    "MONTERREY", "MORELIA", "MORELOS", "MOTUL-TIZIMIN", "NAVOJOA",
    "NOGALES", "NUEVO-LAREDO", "OAXACA", "OBREGON", "ORIZABA", 
    "PIEDRAS-NEGRAS", "POZA-RICA", "PUEBLA", "QUERETARO", "REYNOSA",
    "RIVIERA-MAYA", "SABINAS", "SALTILLO", "SALVATIERRA", "SAN-CRISTOBAL", 
    "SAN-JUAN-DEL-RIO", "SAN-LUIS-POTOSI", "SAN-MARTIN", "TAMPICO", "TAPACHULA",
    "TECAMACHALCO", "TEHUACAN", "TEHUANTEPEC", "TEPIC-VALLARTA", "TEZIUTLAN", 
    "TICUL", "TLAXCALA", "TUXTLA", "URUAPAN", "VDM-CENTRO",
    "VDM-NORTE", "VDM-SUR", "VERACRUZ", "VICTORIA", "VILLAHERMOSA", 
    "XALAPA", "ZACAPU", "ZACATECAS", "ZAMORA", "ZAPOTLAN", "ZIHUATANEJO"
]
